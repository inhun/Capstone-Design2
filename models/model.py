...
class HunNet(nn.Module):
    def __init__(self, block=BasicBlock, num_classes=2):
        ...
        self.layer3 = Tree(block, 64, 128, level=2, stride=2)
        self.layer4 = Tree(block, 128, 256, level=2, stride=2)
        self.layer5 = Tree(block, 256, 512, level=1, stride=2)
    ...
    def forward(self, x):
        ...
        out8 = F.avg_pool2d(out7, 4)
        out9 = out8.view(out8.size(0), -1)
        out10 = self.linear(out9)
        # return out10
